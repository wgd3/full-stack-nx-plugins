...
describe('nx-sass-lib e2e', () => {
  ...
  it('should create nx-sass-lib', async () => {
    ...
    await runNxCommandAsync(
      `generate @wgd3/nx-sass-lib:nx-sass-lib ${project}`
    );
  ...
  describe('--directory', () => {
    it('should create src in the specified directory', async () => {
      const project = uniq('nx-sass-lib');
      await runNxCommandAsync(
        `generate @wgd3/nx-sass-lib:nx-sass-lib ${project} --directory subdir`
      );
      expect(() =>
  ...
  describe('--tags', () => {
    it('should add tags to the project', async () => {
      ...
      ensureNxProject('@wgd3/nx-sass-lib', 'dist/packages/nx-sass-lib');
      await runNxCommandAsync(
        `generate @wgd3/nx-sass-lib:nx-sass-lib ${projectName} --tags e2etag,e2ePackage`
      );
